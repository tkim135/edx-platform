...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cme_reg_form', '0003_auto_20170313_1521'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='extrainfo',
            name='affiliation',
            field=models.CharField(default='', max_length=50, choices=[(b"Stanford Children's Health", b"Stanford Children's Health"), (b"Packard Children's Health Alliance (PCHA)", b"Packard Children's Health Alliance (PCHA)"), (b'Stanford Health Care', b'Stanford Health Care'), (b'Stanford University', b'Stanford University'), (b'University Healthcare Alliance (UHA)', b'University Healthcare Alliance (UHA)'), (b'Not affiliated with Stanford Medicine', b'Not affiliated with Stanford Medicine')]),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='extrainfo',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(default='', max_length=25, blank=True, choices=[(b'Adult', b'Adult'), (b'Pediatric', b'Pediatric'), (b'Both', b'Both'), (b'None', b'None')]),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='extrainfo',
            name='physician_status',
            field=models.CharField(default='', max_length=8, blank=True, choices=[(b'Active', b'Active'), (b'Resident', b'Resident'), (b'Fellow', b'Fellow'), (b'Retired', b'Retired')]),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='extrainfo',
        ...
        migrations.AlterField(
            model_name='extrainfo',
            name='sunet_id',
            field=models.CharField(default='', max_length=33, blank=True),
            preserve_default=False,
        ),
    ]
