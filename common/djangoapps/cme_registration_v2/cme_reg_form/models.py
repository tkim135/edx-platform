...
class ExtraInfo(models.Model):
    ...
    birth_date = models.CharField(max_length=5)
    ...
    PROFESSIONAL_DESIGNATION_CHOICES = (('AuD', 'AuD'),
                                        ...
                                        ('Other', 'Other'),
                                        ('None', 'None'))
    professional_designation = models.CharField(max_length=10, choices=PROFESSIONAL_DESIGNATION_CHOICES)
    ...
    license_country = models.CharField(max_length=50, blank=True, choices=COUNTRY_CHOICES)
    ...
    STATE_CHOICES = (('AL', 'Alabama'),
                     ...
                     ('WI', 'Wisconsin'),
                     ('WY', 'Wyoming'))
    license_state = models.CharField(max_length=50, blank=True, choices=STATE_CHOICES)

    PHYSICIAN_STATUS_CHOICES = (('Active', 'Active'),
                                ('Resident', 'Resident'),
                                ('Fellow', 'Fellow'),
                                ('Retired', 'Retired'))
    physician_status = models.CharField(max_length=8, blank=True, choices=PHYSICIAN_STATUS_CHOICES)

    PATIENT_POPULATION_CHOICES = (('Adult', 'Adult'),
                                  ('Pediatric', 'Pediatric'),
                                  ('Both', 'Both'),
                                  ('None', 'None'))
    patient_population = models.CharField(max_length=25, blank=True, choices=PATIENT_POPULATION_CHOICES)
    ...
    specialty = models.CharField(max_length=255, blank=True, choices=SPECIALTY_CHOICES)
    ...
    other_affiliation = models.CharField(max_length=50, blank=True) # Not used?

    sub_affiliation = models.CharField(max_length=50, blank=True)
    ...
    stanford_department = models.CharField(max_length=50, blank=True, choices=DEPARTMENT_CHOICES)

    sunet_id = models.CharField(max_length=33, blank=True)
    ...
    county_province = models.CharField(max_length=50, blank=True)
